...
const Home = () => {
    ...
    // Bug #4 follow-up: hook no longer fetches automatically — Home controls when to load
    useEffect(() => {
        getReports()
    }, [])
    ...
    const handleGenerateReport = async () => {
        ...
        if (!resumeFile && (!selfDescription || !selfDescription.trim())) {
            setErrorMessage("Please provide either your resume PDF or a quick self-description.")
            return
        }
        ...
        try {
            ...
            setErrorMessage(err.message || "Failed to generate interview strategy. Please try again.")
        }
    }
